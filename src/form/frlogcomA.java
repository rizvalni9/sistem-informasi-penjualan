...
public class frlogcomA extends javax.swing.JDialog {
    ...
    public frlogcomA(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        con.root();
        initComponents();
        cekData();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frlogcomA.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
